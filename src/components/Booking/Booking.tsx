...
import type { BookingFormState, BookingFields } from '../../types'

interface BookingProps {
  onToast: (message: string, color?: string) => void
}

export default function Booking({ onToast }: BookingProps) {
  const { t } = useTranslation()
  const [form, setForm] = useState<BookingFormState>({
    ownerName: '', phone: '', petName: '', petType: '', service: '', date: '',
  })

  const fields = t('booking.fields', { returnObjects: true }) as BookingFields
